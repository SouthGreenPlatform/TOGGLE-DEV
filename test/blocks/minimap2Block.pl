...
my $testingDir="$toggle/dataTest/minimap2-noSGE-Blocks";
my $cleaningCmd="rm -Rf $testingDir";
system ($cleaningCmd) and die ("ERROR: $0 : Cannot remove the previous test directory with the command $cleaningCmd \n$!\n");

#Creating config file for this test
my @listSoft = ("minimap2");
...
system("$runCmd") and die "#### ERROR : Can't run TOGGLE for minimap2";
...
is_deeply(\@observedOutput,\@expectedOutput,'toggleGenerator - Two FILES (no SGE) minimap2::minimap2Index file list ');
