...
is(wtdbg2::wtdbg2(FILEIN,FILEOUT,$optionHachees),1,'wtdbg2::wtdbg2  - Test for wtdbg2 running');

# expected output test
my $observedOutput = `ls`;
my @observedOutput = split /\n/,$observedOutput;
my @expectedOutput = ('FILEOUT','wtdbg2_log.e','wtdbg2_log.o');
is_deeply(\@observedOutput,\@expectedOutput,'wtdbg2::wtdbg2 - output list');
