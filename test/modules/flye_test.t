...
my $type="flyeNanoRaw";
is(flye::flye($fastaIn,$dirOut,$optionHachees, $type),1,'flye::flyeNanoRaw  - Test for flyeNanoRaw running');

# expected output test
my $observedOutput = `ls $dirOut`;
...
is_deeply(\@observedOutput,\@expectedOutput,'flye::flyeNanoRaw - output list');
