...
if ($previousExtension !~ m/fasta|fastq|vcf|sam|bam|ped|gtf/)  # j'ai rajouté fasta pour les besoins de TGICL et moi ped pour SNIPLAY; GTF for stringtie (option merge)
{
