...
sub generateReports
{
	...
	my $texWorkflowFile=$outDir."/texReport/workflow/TOGGLe_Workflow_Report.tex";
	my $pdfWorkflowFile=$outDir."/texReport/workflow/TOGGLe_Workflow_Report.pdf";
	# Report file name generated by TOGGLe to describe workflow architecture
	#my $texAnalysisFile=$outDir."/texReport/workflow/TOGGLe_Analysis_Report.tex"; 
	
	`cd $outDir/texReport/workflow/`;
	`pwd`;
