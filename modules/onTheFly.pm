...
sub generateGraphviz
{
    ...
    # Dot header
    print OUT "digraph G \n{
    \tgraph [fontsize=18,fontname=Arial, colorscheme=X11,  nodesep=1, compound=true;]
	node [label=\"\\N\",  style=\"rounded,filled\", width=4, fontcolor=white, fontsize=18]
...
sub generateReports
{
	...
	# Report file name generated by TOGGLe to describe analysis performed
	# my $texAnalysisFile=$outDir."/texReport/workflow/TOGGLe_Analysis_Report.tex"; 
